...
<div class="card">
    <div class="card-header">
        <h4 class="mb-0">Editar Usuario: <?php echo htmlspecialchars($usuario_data['nombre'] . ' ' . $usuario_data['apellido']); ?></h4>
    </div>
    <div class="card-body">
        <form method="POST" action="">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nombre" class="form-control" value="<?php echo htmlspecialchars($usuario_data['nombre']); ?>" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Apellido</label>
                    <input type="text" name="apellido" class="form-control" value="<?php echo htmlspecialchars($usuario_data['apellido']); ?>" required>
                </div>
            </div>
