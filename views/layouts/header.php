...
<head>
    ...
    <style>
        ...
        .sidebar { background-color: #000000; min-height: calc(100vh - 56px); padding-top: 20px; }
        .sidebar a { color: #ffffff; text-decoration: none; display: block; padding: 10px 15px; }
        .sidebar a:hover { background-color: #28a745; color: #000000; }
        ...
        .table-dark th { background-color: #000000 !important; color: #28a745 !important; }
        .btn-success { background-color: #28a745; border-color: #28a745; }
        .form-control { background-color: #2d2d2d !important; border-color: #444 !important; color: #ffffff !important; }
        .form-control:focus { background-color: #2d2d2d !important; border-color: #28a745 !important; color: #ffffff !important; box-shadow: 0 0 0 0.25rem rgba(40, 167, 69, 0.25) !important; }
    </style>
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <span class="nav-link"><?php echo $_SESSION['user_name']; ?> (<?php echo $_SESSION['user_role']; ?>)</span>
