                    ...
                    <?php foreach ($inscripciones as $inscripcion): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <span
                                    class="badge bg-<?php echo $estado_clase; ?>"><?php echo ucfirst($inscripcion['estado']); ?></span>
                            </td>
                            <td>
                                ...
                                <form method="POST" action="" class="d-inline">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="number" name="nota_final" class="form-control form-control-sm"
                                            placeholder="Nota" step="0.01" min="0" max="100"
                                            value="<?php echo $inscripcion['nota_final'] ?? ''; ?>" style="width: 80px;">
                            ...
                            <td>
                                <?php if ($inscripcion['estado'] === 'aprobado'): ?>
                                    <form method="POST" action="index.php?controller=Curso&action=reenviarCertificado"
                                        class="d-inline">
                                        <input type="hidden" name="inscripcion_id" value="<?php echo $inscripcion['id']; ?>">
                                        <button type="submit" class="btn btn-outline-info btn-sm" title="Reenviar Certificado">
