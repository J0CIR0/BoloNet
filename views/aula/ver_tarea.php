    ...
    <div class="container">
        ...
        <?php if ($esProfesor): ?>
            <div class="card bg-dark border-secondary shadow-lg">
                <div class="card-header bg-secondary bg-opacity-25 border-secondary d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <table class="table table-dark table-striped table-hover mb-0 align-middle">
                            <thead>
                                <tr class="text-white-50 small text-uppercase">
                                    ...
                                    <th>Archivo</th>
                                    <th>Comentario</th>
                                    <th style="min-width: 150px;">Calificación (Max: <?php echo $tarea['puntaje_maximo']; ?>)</th>
                            ...
                            <tbody>
                                <?php if (empty($entregas)): ?>
                                    <tr>
                                        <td colspan="7" class="text-center py-4 text-white-50">No hay entregas registradas aún.</td>
                                    </tr>
                                <?php else: ?>
                        ...
                        <table class="table table-dark table-striped table-hover mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($entrega): ?>
                                            <span class="bg-success bg-opacity-25 text-success px-2 py-1 rounded">Enviado para calificar</span>
                                        <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <span class="bg-secondary bg-opacity-25 text-white-50 px-2 py-1 rounded">Sin calificar</span>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                ...
                                <?php if ($entrega && $entrega['retroalimentacion']): ?>
                                    <tr class="table-success">
                                        ...
                                        <td class="text-success text-break">
                                            <strong>Calificación: <?php echo $entrega['calificacion']; ?> / <?php echo $tarea['puntaje_maximo']; ?></strong><br>
            ...
            <div class="text-center mt-4">
                <?php if (!$entrega): ?>
                    <?php if (!$timeInfo['is_late']): ?>
                        <button class="btn btn-primary px-4 py-2 w-100 w-md-auto mb-2 mb-md-0" type="button" data-bs-toggle="collapse" data-bs-target="#formEntrega">
                            Agregar entrega
                        </button>
                    <?php else: ?>
                    ...
                    <?php if (!$entrega['calificacion']): ?>
                        <div class="d-flex flex-column flex-md-row justify-content-center gap-2">
                            ...
                            <form action="index.php?controller=Aula&action=eliminar_entrega" method="POST"
                                onsubmit="return confirm('¿Estás seguro de que quieres quitar tu envío? Se borrará el archivo y el comentario.');" class="w-100 w-md-auto">
                                <input type="hidden" name="tarea_id" value="<?php echo $tarea['id']; ?>">
                    ...
                    <div class="card-body">
                        <form action="index.php?controller=Aula&action=subir_tarea" method="POST"
                            ...
                            <div class="mb-4 text-center border border-secondary border-dashed p-4 p-md-5 rounded">
                                ...
                                <div class="mb-3">
                                    <label class="form-label text-white-50 small mb-1"><?php echo $entrega ? 'Reemplazar archivo (opcional)' : 'Seleccionar archivo'; ?></label>
                                    <input type="file" name="archivo_tarea"
                                        class="form-control bg-dark text-white border-secondary" <?php echo $entrega ? '' : 'required'; ?>>
                                </div>
                                <p class="text-muted small">Arrastre y suelte los archivos aquí o use el selector de archivos.</p>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-success px-4 w-100 w-md-auto mb-2 mb-md-0">Guardar cambios</button>
                                <button type="button" class="btn btn-outline-light px-4 w-100 w-md-auto" data-bs-toggle="collapse"
