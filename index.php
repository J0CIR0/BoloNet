...
<style>
    ...
    body {
        background: linear-gradient(135deg, #000000 0%, #1a4d2e 100%); /* Negro a Verde oscuro */
        min-height: 100vh;
        display: flex;
    ...
    <div class="row w-100 justify-content-center align-items-center">
        ...
        <div class="col-md-6 col-lg-5 text-white hero-section px-4">
            ...
            <div class="d-flex gap-3 mt-4 d-none d-md-flex">
                <div class="d-flex align-items-center text-success"><i class="fas fa-check-circle me-2"></i> Accesible</div>
                <div class="d-flex align-items-center text-success"><i class="fas fa-check-circle me-2"></i> Rápido</div>
                <div class="d-flex align-items-center text-success"><i class="fas fa-check-circle me-2"></i> Seguro</div>
            </div>
        </div>
                    ...
                    <form method="POST" action="">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control form-control-custom border-start-0 ps-2" placeholder="ejemplo@correo.com" required>
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn btn-success w-100 py-3 fw-bold shadow-lg text-uppercase mb-3" style="border-radius: 10px;">
